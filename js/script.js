const APIKey = "d086e75f514956ab3667a4cbe1da992e";
...
const handleSearch = (event) => {
    ...
    let weatherURL = `https://api.openweathermap.org/geo/1.0/direct?q=${searchInput}&limit=1&appid=d086e75f514956ab3667a4cbe1da992e`;
    fetch(weatherURL)
